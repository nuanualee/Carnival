...
public class PlayKPopSongActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menu_button.setOnClickListener(new View.OnClickListener() { //FIRST ONCLICK
            ...
            public void onClick(View v) {
                PopupMenu popup = new PopupMenu(PlayKPopSongActivity.this, menu_button);
                popup.getMenuInflater().inflate(R.menu.menu_popup, popup.getMenu());
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    @Override
                    public boolean onMenuItemClick(MenuItem item) {//SECOND ONCLICK
                        Toast.makeText(PlayKPopSongActivity.this, item.getTitle(), Toast.LENGTH_SHORT).show();

                        int id = item.getItemId();
                        if (id == R.id.addToPlaylist) {
                            Intent intent = new Intent(PlayKPopSongActivity.this, AddToPlaylist.class);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PlayKPopSongActivity.this, MainActivity.class);
                startActivity(intent);
            }
        });
    ...
    public void displaySongBasedOnIndex(int selectedIndex) {
        KPopSong kPopSong = kPopSongCollection.getCurrentSong(selectedIndex);
        title = kPopSong.getTitle();
        Log.d("temasek", "the title is: " + title);
        artiste = kPopSong.getArtiste();
        filelink = kPopSong.getFileLink();
        drawable = kPopSong.getDrawable();
    ...
    private void gracefullyStopsWhenMusicEnds() { //new method to allow music player to go back to PLAY
        player.setOnCompletionListener(new MediaPlayer.OnCompletionListener() { //goig to listen: when it completed played
            ...
            public void onCompletion(MediaPlayer mp) { //ON COMPLETION, finished playing
                Toast.makeText(PlayKPopSongActivity.this, "Song ended", Toast.LENGTH_SHORT).show();

                if (repeatFlag) {
                    playOrPauseSong(null);
                    //init dialog
                    dialogBeeRepeat = new Dialog(PlayKPopSongActivity.this);
                    //show dialog
    ...
    public void playNext(View view) {
        //init dialog
        dialog = new Dialog(PlayKPopSongActivity.this);
        //show dialog
        dialog.show();
        ...
        currentIndex = kPopSongCollection.getNextSong(currentIndex);
    ...
    public void playPrevious(View view) {
        currentIndex = kPopSongCollection.getPrevSong(currentIndex);
