...
public class PlayRapSongActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menu_button.setOnClickListener(new View.OnClickListener() { //FIRST ONCLICK
            ...
            public void onClick(View v) {
                PopupMenu popup = new PopupMenu(PlayRapSongActivity.this, menu_button);
                popup.getMenuInflater().inflate(R.menu.menu_popup, popup.getMenu());
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    @Override
                    public boolean onMenuItemClick(MenuItem item) {//SECOND ONCLICK
                        Toast.makeText(PlayRapSongActivity.this, item.getTitle(), Toast.LENGTH_SHORT).show();

                        int id = item.getItemId();
                        if (id == R.id.addToPlaylist) {
                            Intent intent = new Intent(PlayRapSongActivity.this, AddToPlaylist.class);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PlayRapSongActivity.this, MainActivity.class);
    ...
    public void displaySongBasedOnIndex(int selectedIndex) {
        RapSong rapSong = rapSongCollection.getCurrentSong(selectedIndex);
        title = rapSong.getTitle();
        Log.d("temasek", "the title is: " + title);
        artiste = rapSong.getArtiste();
        filelink = rapSong.getFileLink();
        drawable = rapSong.getDrawable();
    ...
    private void gracefullyStopsWhenMusicEnds() { //new method to allow music player to go back to PLAY
        player.setOnCompletionListener(new MediaPlayer.OnCompletionListener() { //goig to listen: when it completed played
            ...
            public void onCompletion(MediaPlayer mp) { //ON COMPLETION, finished playing
                Toast.makeText(PlayRapSongActivity.this, "Song ended", Toast.LENGTH_SHORT).show();

                if (repeatFlag){
                    playOrPauseSong(null);
                    //init dialog
                    dialogBeeRepeat = new Dialog(PlayRapSongActivity.this);
                    //show dialog
