...
public class PlayDanceElectronicActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {//SECOND ONCLICK
                        ...
                        if (id == R.id.addToPlaylist) {
                            Intent intent = new Intent(PlayDanceElectronicActivity.this, AddToPlaylist.class);
                            intent.putExtra("TITLE", title);
                            startActivity(intent);
                        } else if (id == R.id.addToMoments) {
                            Intent intent2 = new Intent(PlayDanceElectronicActivity.this, NewMomentsActivity.class);

                            currentIndex = bundle.getInt("pfp");
                            Log.d("bark", "PLAYDANCEELECACTIVITY sending: " + currentIndex);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PlayDanceElectronicActivity.this, MainActivity.class);
    ...
    public void displaySongBasedOnIndex(int selectedIndex) {
        ...
        title = danceElecSong.getTitle();
        Log.d("temasek", "the title is: " + title);
        artiste = danceElecSong.getArtiste();
        filelink = danceElecSong.getFileLink();
        drawable = danceElecSong.getDrawable();
    ...
    public void playNext(View view) {
        //init dialog
        dialog = new Dialog(PlayDanceElectronicActivity.this);
        //show dialog
        dialog.show();
    ...
    public void playPrevious(View view) {
        currentIndex = danceElecSongCollection.getPrevSong(currentIndex);
