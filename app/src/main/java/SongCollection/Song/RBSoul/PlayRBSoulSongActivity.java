...
public class PlayRBSoulSongActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {//SECOND ONCLICK
                        ...
                        if (id == R.id.addToPlaylist) {
                            Intent intent = new Intent(PlayRBSoulSongActivity.this, AddToPlaylist.class);
                            intent.putExtra("TITLE", title);
                            startActivity(intent);
                        } else if (id == R.id.addToMoments) {
                            Intent intent2 = new Intent(PlayRBSoulSongActivity.this, NewMomentsActivity.class);

                            currentIndex = bundle.getInt("pfp");
                            Log.d("bark", "PLAYRBSOULACTIVITY sending: " + currentIndex);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PlayRBSoulSongActivity.this, MainActivity.class);
    ...
    public void displaySongBasedOnIndex(int selectedIndex) {
        RBSoulSong rbSoulSong = rbSoulSongCollection.getCurrentSong(selectedIndex);
        title = rbSoulSong.getTitle();
        Log.d("temasek", "the title is: " + title);
        artiste = rbSoulSong.getArtiste();
        filelink = rbSoulSong.getFileLink();
        drawable = rbSoulSong.getDrawable();
    ...
    public void playNext(View view) {
        //init dialog
        dialog = new Dialog(PlayRBSoulSongActivity.this);
        //show dialog
        dialog.show();
    ...
    public void playPrevious(View view) {
        currentIndex = rbSoulSongCollection.getPrevSong(currentIndex);
