...
public class PlayHipHopSongActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menu_button.setOnClickListener(new View.OnClickListener() { //FIRST ONCLICK
            ...
            public void onClick(View v) {
                PopupMenu popup = new PopupMenu(PlayHipHopSongActivity.this, menu_button);
                popup.getMenuInflater().inflate(R.menu.menu_popup, popup.getMenu());
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    @Override
                    public boolean onMenuItemClick(MenuItem item) {//SECOND ONCLICK
                        Toast.makeText(PlayHipHopSongActivity.this, item.getTitle(), Toast.LENGTH_SHORT).show();

                        int id = item.getItemId();
                        if (id == R.id.addToPlaylist) {
                            Intent intent = new Intent(PlayHipHopSongActivity.this, AddToPlaylist.class);
                            intent.putExtra("TITLE", title);
                            startActivity(intent);
                        } else if (id == R.id.addToMoments) {
                            Intent intent2 = new Intent(PlayHipHopSongActivity.this, NewMomentsActivity.class);

                            currentIndex = bundle.getInt("pfp");
                            Log.d("bark", "PLAYHIPHOPACTIVITY sending: " + currentIndex);
                            ...
                            Intent intent3 = new Intent(PlayHipHopSongActivity.this, Countdown.class);
    ...
    public void displaySongBasedOnIndex(int selectedIndex) {
        HHSong hhSong = hhSongCollection.getCurrentSong(selectedIndex);
        title = hhSong.getTitle();
        Log.d("temasek", "the title is: " + title);
        artiste = hhSong.getArtiste();
        filelink = hhSong.getFileLink();
        drawable = hhSong.getDrawable();
